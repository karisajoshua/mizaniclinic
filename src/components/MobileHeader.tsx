  ...
  return <header className="sticky top-0 z-50 w-full bg-gradient-to-r from-[#00122D] via-[#00122D] to-[#00122D] backdrop-blur-md border-b border-white/10 shadow-xl">
      <div className="container mx-auto px-4 h-16 flex items-center justify-between">
        ...
        <Sheet>
          ...
          <SheetContent side="right" className="w-80 bg-gradient-to-b from-[#00122D] to-[#00122D] border-white/10">
            ...
            <nav className="space-y-2">
              ...
              return <Link key={item.href} to={item.href} className={`flex items-center space-x-3 px-4 py-3 rounded-xl transition-all duration-200 ${isActive(item.href) ? "bg-gradient-to-r from-tanzania-green to-green-400 text-white shadow-lg" : "text-blue-100 hover:bg-white/10 hover:text-white"}`}>
        ...
        <nav className="hidden lg:flex items-center space-x-1">
          {navItems.map(item => {
          const Icon = item.icon;
          return <Link key={item.href} to={item.href} className={`flex items-center space-x-2 px-4 py-2 rounded-lg transition-all duration-200 ${isActive(item.href) ? "bg-tanzania-green text-white shadow-md" : "text-blue-100 hover:bg-white/10 hover:text-white"}`}>
